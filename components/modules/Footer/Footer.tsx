...
const Footer = () => {
  return (
    <>
      <footer className="relative border-t-8 border-t-text-200 z-10 bg-white pb-10 pt-20 lg:pb-20 lg:pt-[120px]">
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
              <div className="mb-10 w-full">
                ...
                <div className="mb-6 flex items-center">
                  <a
                    href="#"
                    className="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-stroke text-dark hover:border-primary hover:bg-primary hover:text-primary-100 text-primary-300 sm:mr-4 lg:mr-3 xl:mr-4"
                  >
                    <svg
                      width="8"
                      height="16"
