    ...
    <div className=" overflow-x-hidden p-6 text-text-200">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
        <div className="bg-white rounded-md border border-gray-100 p-6 shadow-md shadow-black/5">
          <div className="flex justify-between mb-6">
            <div>
              ...
              <div className="text-sm font-medium text-gray-400">Studens</div>
            </div>
            <div className="group">
              <button
                type="button"
        ...
        <div className="bg-white rounded-md border border-gray-100 p-6 shadow-md shadow-black/5">
          <div className="flex justify-between mb-6">
            <div>
              <div className="text-2xl font-semibold mb-1">89</div>
                ...
                <tr key={user._id}>
                  ...
                  <td className="py-2 px-4 border-b border-b-gray-50">
                    <div className="flex items-center">
                      <a
                        href="#"
                        className="text-text-100 text-sm font-medium hover:text-primary-300 ml-2 truncate max-w-40"
                      >
